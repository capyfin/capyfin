...
const MOCK_SKILLS = [
  {
    ...
    version: "1.0.0",
    downloadUrl:
      "https://registry.clawhub.dev/v1/skills/crypto-tracker/download",
  },
  {
    id: "forex-monitor",
    name: "Forex Monitor",
    ...
    version: "0.2.0",
    downloadUrl:
      "https://registry.clawhub.dev/v1/skills/forex-monitor/download",
  },
];
...
void test("downloadSkillById finds and downloads the correct skill", async () => {
  ...
  try {
    ...
    const skillDir = await client.downloadSkillById(
      "crypto-tracker",
      targetDir,
    );
