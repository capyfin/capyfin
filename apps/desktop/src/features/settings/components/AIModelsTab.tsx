  ...
  return (
    <div className="flex flex-col gap-5" data-testid="ai-models-tab">
      ...
      {storedConnections.length === 0 ? (
        <div className="rounded-xl border border-dashed border-border/50 bg-card px-5 py-8 text-center text-[13px] text-muted-foreground shadow-sm dark:border-border/30">
