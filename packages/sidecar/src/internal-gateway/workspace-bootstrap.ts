...
const LEGACY_CAPYFIN_MARKERS = [
  "CapyFin Main",
  "CapyFin Workspace",
  "Primary CapyFin finance orchestration agent.",
  "a CapyFin agent",
  "Product: CapyFin",
] as const;
...
function containsLegacyCapyfinPersona(content: string): boolean {
  return LEGACY_CAPYFIN_MARKERS.some((marker) => content.includes(marker));
}
